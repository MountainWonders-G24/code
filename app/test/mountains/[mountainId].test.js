...
describe('GET api/mountains/[mountainId]', () => {
    beforeAll(async () => {
    ...
    test('GET retrieve mountain with right search string', async () => {
    ...
    test('GET retrieve mountain with wrong search string', async () => {
